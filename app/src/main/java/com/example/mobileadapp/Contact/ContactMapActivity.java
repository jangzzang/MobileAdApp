...
public class ContactMapActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng IT2 = new LatLng(35.88725,128.61142);
/*
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(IT2,15));
        MarkerOptions markerOptions = new MarkerOptions();
        markerOptions.position(IT2);
        markerOptions.title("모바일 공학과 사무실 위치");
...
*/
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( ContactMapActivity.this, REQUIRED_PERMISSIONS,
    ...
    private void startLocationUpdates() {
        ...
        if (!checkLocationServicesStatus()) {
            ...
            Toast.makeText(this, "위치를 활성화 하시면 현재 본인의 위치와 모바일 사무실의 거리도 파악할 수 있습니다 ^^", Toast.LENGTH_SHORT).show();
